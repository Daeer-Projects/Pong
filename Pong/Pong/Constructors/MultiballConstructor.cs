...
{
    public class MultiballConstructor : LevelConstructor
    {
        ...
        public MultiballConstructor(GameplayScreen game, OptionsSelected gameOptions)
            : base(game, gameOptions)
        {
            ...
            GameTypeMode = new MultiballMode(Game, _timer, CollisionManagers, Sprites);
        }
