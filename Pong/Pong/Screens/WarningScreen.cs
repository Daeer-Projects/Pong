...
namespace Pong.Screens
{
    public class WarningScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            var textPosition = new Vector2(font.GetWidth(WarningLine1)/10, startY);

            Color color = Color.White;

            // Draw the text.
            spriteBatch.Begin();
            spriteBatch.DrawString(font, WarningLine1, textPosition, color, 0f, Vector2.Zero, 0.6f, SpriteEffects.None,
                                   0f);

            startY += 25;
            textPosition = new Vector2(font.GetWidth(WarningLine2)/12, startY);
            spriteBatch.DrawString(font, WarningLine2, textPosition, color, 0f, Vector2.Zero, 0.6f, SpriteEffects.None,
                                   0f);

            startY += 25;
            textPosition = new Vector2(font.GetWidth(WarningLine3)/12, startY);
            spriteBatch.DrawString(font, WarningLine3, textPosition, color, 0f, Vector2.Zero, 0.6f, SpriteEffects.None,
                                   0f);

            startY += 25;
            textPosition = new Vector2(font.GetWidth(WarningLine4)/10, startY);
            spriteBatch.DrawString(font, WarningLine4, textPosition, color, 0f, Vector2.Zero, 0.6f, SpriteEffects.None,
                                   0f);

            startY += 50;
            textPosition = new Vector2(font.GetWidth(WarningLine5)/12, startY);
            spriteBatch.DrawString(font, WarningLine5, textPosition, color, 0f, Vector2.Zero, 0.6f, SpriteEffects.None,
                                   0f);

            startY += 25;
            textPosition = new Vector2(font.GetWidth(WarningLine6)/9, startY);
            spriteBatch.DrawString(font, WarningLine6, textPosition, color, 0f, Vector2.Zero, 0.6f, SpriteEffects.None,
                                   0f);
            spriteBatch.End();
        }
    }
